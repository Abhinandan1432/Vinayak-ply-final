    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-12" style="height: 50vh;">
                <div class="about_one">
                    <img src="./assets/images/about_one.png" class="img-fluid" alt="about_one"
                        style="border: 8px solid #A6CE39;">
                </div>
                <div class="about_two">
                    <img src="./assets/images/about_two.png" class="img-fluid" alt=" about_two"
                        style="border: 8px solid #ED1C24;">
                </div>
                <div class="about_three">
                    <img src="./assets/images/about_three.png" class="img-fluid" alt="about_three"
                        style="border: 6px solid #ECECEC;">
                </div>
            </div>
            <div class="col-md-6 col-12">
                <div class="">
                    ...
                    <hr style="width: 100px; color:#ED1C24; height: 2px;">
                    <p class="paragraph ">
                    ...
                    <div class="">
                        <a href="#"><button class="t-button paragraph" style="color: red;">Download
                                Catalogue</button></a>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8 col-12">
                <div class="pt-5">
                    ...
                    <hr style="color: red; height:2px; width:5rem;">
                    <ul>
                        <li class="paragraph">
