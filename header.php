        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                ...
                <div class="d-block d-md-none">
                    <form class="">
                        <!-- <button class="red-button" type="submit"><i class="fa-sharp fa-solid fa-phone"></i></button> -->
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./product_single.php">Product Single</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./contact.php">Contact</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="./e-catelogue.php">E-Catalogue</a>
                        </li>
                        <li class="nav-item">
