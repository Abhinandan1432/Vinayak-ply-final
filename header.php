                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-sm-4 col-md-4">
                                                ...
                                                <div id="red-line"></div>
                                                <div class="list-group">
                                                    <a class="list-group-item px-0 fw-bold" href="#">Flash Doors</a>
                                                    <a class="list-group-item px-0 fw-bold" href="#">Block Doors</a>
                                                    <a class="list-group-item px-0 fw-bold" href="#">Mauryan Doors</a>
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body text-center">
          <h3 class="fw-bold">SUBSCRIBE OUR <br> <span style="color:#A6CE39;">NEWSLETTER</span></h3>
          <div class="input-group mb-3">
            ...
            <span class="input-group-text red-button" id="basic-addon2">SUBSCRIBE</span>
          </div>
        </div>
      </div>
    </div>
