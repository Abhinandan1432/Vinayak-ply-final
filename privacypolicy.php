            ...
            <div class="col-12">
                <div class="">
                    ...
                    <p class="paragraph">
                        ...
                        collection and use of information by this Privacy Policy. This Privacy Policy has been created
                        with the help of the Free Privacy Policy Generator.
                    </p>
                    <h3 class="heading_three text-uppercase">Interpretation and Definitions</h3>
                    <h4 class="heading_four text-uppercase">Interpretation</h4>
                    <p class="paragraph">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            party, whereas "control" means ownership of 50% or more of the shares, equity interest or
                            other securities entitled to vote for the election of directors or other managing authority.
                        </li>
                        <li>
                            Application means the software program provided by the Company downloaded by You on any
                            electronic device, named Vinayak Ply
                        </li>
                        <li>
                            Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers
                            to Vinayak Ply, Parvatiya Vikas Udyog Shala, 232, Peerumadara, Ring Road Papdi, Ramnagar
                            244715
                        </li>
                        <li>
                    ...
                    <h3 class="heading_three text-uppercase">Retention of Your Personal Data</h3>
                    <p class="paragraph">
                        The Company will retain Your Personal Data only for as long as is necessary for the purposes set
                        out in this Privacy Policy. We will retain and use Your Data to the extent necessary to comply
                    ...
                    <h3 class="heading_three text-uppercase">Transfer of Your Personal Data</h3>
                    <p class="paragraph">
                        ...
                        from those of Your jurisdiction.<br>

                        Your consent to this Privacy Policy followed by Your submission of such information represents
                        Your agreement to that transfer.

                        The Company will take all steps reasonably necessary to ensure that Your data is treated
                        securely and by this Privacy Policy and no transfer of Your Personal Data will take place to an
                    ...
                    <h3 class="heading_three text-uppercase">Disclosure of Your Personal Data</h3>
                    <h4 class="heading_four text-uppercase">Business Transactions</h4>
                    <p class="paragraph">
                        If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be
                        transferred. We will provide notice before Your Personal Data is transferred and becomes subject
                        to a different Privacy Policy.
                    </p>
                    <h4 class="heading_four text-uppercase">Law enforcement</h4>
                    <p class="paragraph">
                        Under certain circumstances, the Company may be required to disclose Your Data if required to do
                    ...
                    <h4 class="heading_four text-uppercase">Security of Your Personal Data</h4>
                    <p class="paragraph">
                    ...
                    <h4 class="heading_four text-uppercase">Children's Privacy</h4>
                    <p class="paragraph">
                    ...
                    <h4 class="heading_four text-uppercase">Links to Other Websites</h4>
                    <p class="paragraph">
                    ...
                    <h4 class="heading_four text-uppercase">Changes to this Privacy Policy</h4>
                    <p class="paragraph">
                        ...
                        becomes effective and update the "Last updated" date at the top of this Privacy Policy.<br>
